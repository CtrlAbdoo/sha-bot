...
python3 -c "import fastapi, uvicorn, dotenv, pymongo, loguru" > /dev/null 2>&1
if [ $? -ne 0 ]; then
...
cd ..
python3 -m uvicorn app.finetuned_api:app --host 0.0.0.0 --port 8000 